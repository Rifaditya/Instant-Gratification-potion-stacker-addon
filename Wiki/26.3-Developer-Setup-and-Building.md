...
This guide details the technical specifications, Loom compiler toolchains, and build procedures for compiling the **Minecraft 26.3** anchor (`MC 26.3-snapshot-6 / 26.3`) of Potion Stacker Addon from source.
