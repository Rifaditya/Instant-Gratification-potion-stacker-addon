...
歡迎查閱 **Instant Gratification: Potion Stacker Addon（即時滿足：藥水堆疊擴充）** 面向 **Minecraft 26.3**（針對 `MC 26.3-snapshot-6 / 26.3`）的專用技術文件門戶。該版本樹內的所有文件均嚴格反映針對該快照版本的位元組碼對映、Loom 相依性與功能規範。
...
| 功能特性 / 子系統 | 說明 | 專用維基頁面 |
| :--- | :--- | :--- |
| **藥水堆疊與物品欄人體工學** | 堆疊機制、釀造台互動處理、容器儲存壓縮數學 | [[26.3 藥水堆疊與物品欄人體工學|zh_tw-26.3-Potion-Stacking-and-Inventory-Ergonomics]] |
