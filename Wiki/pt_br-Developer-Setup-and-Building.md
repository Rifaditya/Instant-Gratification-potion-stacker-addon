# 🛠️ Guia de Configuração de Desenvolvedor e Compilação
...
```bash
git clone https://github.com/Rifaditya/Instant-Gratification-potion-stacker-addon.git
cd Instant-Gratification-potion-stacker-addon
```
...
```
Instant Gratification Collection/Potion Stacker Addon/
...
├── potion-stacker-addon/                    # Minecraft 26.2 anchor root project
└── Potion Stacker Addon v26.3/
    └── potion-stacker-addon/                # Minecraft 26.3 anchor root project
```
...
* [[🛠️ Ler 26.2 Ambiente de Desenvolvimento e Toolchain|pt_br-26.2-Developer-Setup-and-Building]]
* [[🛠️ Ler 26.3 Ambiente de Desenvolvimento e Toolchain|pt_br-26.3-Developer-Setup-and-Building]]
