...
Bem-vindo ao portal de documentação técnica dedicada do **Instant Gratification: Potion Stacker Addon** no **Minecraft 26.2** (visando `MC 26.1.2 / 26.2`). Todos os documentos refletem os mapeamentos de bytecode exatos, dependências Loom e especificações deste lançamento.
...
| :--- | :--- | :--- |
| **Empilhamento de Poções e Ergonomia de Inventário** | Mecânicas de empilhamento, suporte de poções, matemática de compressão | [[26.2 Empilhamento de Poções e Ergonomia de Inventário|pt_br-26.2-Potion-Stacking-and-Inventory-Ergonomics]] |
