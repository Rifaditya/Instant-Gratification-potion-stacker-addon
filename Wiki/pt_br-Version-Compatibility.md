...
Potion Stacker Addon relies on **DasikLibrary** for dynamic runtime GameRule registration (`DynamicGameRuleManager`), category allocation, and configuration management (`ConfigHelper`). DasikLibrary follows an open version bound architecture (`>=26.1.2-`).
...
* [[🧪 Ler 26.2 Empilhamento de Poções e Ergonomia de Inventário|pt_br-26.2-Potion-Stacking-and-Inventory-Ergonomics]]
* [[🧪 Ler 26.3 Empilhamento de Poções e Ergonomia de Inventário|pt_br-26.3-Potion-Stacking-and-Inventory-Ergonomics]]
