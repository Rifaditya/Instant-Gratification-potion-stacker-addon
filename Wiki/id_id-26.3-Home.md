...
Selamat datang di portal dokumentasi teknis **Instant Gratification: Potion Stacker Addon** untuk **Minecraft 26.3** (menargetkan `MC 26.3-snapshot-6 / 26.3`). Seluruh dokumentasi mencerminkan pemetaan bytecode, dependensi Loom, dan spesifikasi fitur yang tepat untuk rilis snapshot ini.
...
| :--- | :--- | :--- |
| **Penumpukan Ramuan & Ergonomi Inventaris** | Mekanika penumpukan, penanganan stan pembuatan ramuan, kompresi kontainer | [[26.3 Penumpukan Ramuan & Ergonomi Inventaris|id_id-26.3-Potion-Stacking-and-Inventory-Ergonomics]] |
