...
Bienvenue sur le portail de documentation technique dédié d'**Instant Gratification: Potion Stacker Addon** sur **Minecraft 26.2** (ciblant `MC 26.1.2 / 26.2`). Tous les documents reflètent les correspondances de bytecode exactes, les dépendances Loom et les spécifications de cette version.
...
| :--- | :--- | :--- |
| **Empilement de Potions & Ergonomie d'Inventaire** | Mécaniques d'empilement, gestion de l'alambic, mathématiques de compression | [[26.2 Empilement de Potions & Ergonomie d'Inventaire|fr_fr-26.2-Potion-Stacking-and-Inventory-Ergonomics]] |
