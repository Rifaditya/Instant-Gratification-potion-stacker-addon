...
**Minecraft 26.2**(`MC 26.1.2 / 26.2` 타깃)용 **Instant Gratification: Potion Stacker Addon** 공식 기술 문서 포털에 오신 것을 환영합니다. 이 버전 트리의 모든 문서는 해당 릴리스의 바이트코드 매핑, Loom 종속성 및 기능 사양을 반영합니다.
...
| :--- | :--- | :--- |
| **포션 스태킹 및 인벤토리 인체공학** | 스태킹 메커니즘, 양조기 슬롯 제어, 보관함 압축 계산 | [[26.2 포션 스태킹 및 인벤토리 인체공학|ko_kr-26.2-Potion-Stacking-and-Inventory-Ergonomics]] |
| **네트워크 동기화 및 페이로드** | S2C 페이로드 수명 주기, 핸드셰이크 패킷, 메뉴 동적 갱신 | [[26.2 네트워크 동기화 및 페이로드|ko_kr-26.2-Network-Synchronization-and-Payloads]] |
| **구성 및 동적 게임 규칙** | 모든 GameRule 및 YACL v3 옵션의 전체 참조 매트릭스 | [[26.2 구성 및 동적 게임 규칙|ko_kr-26.2-Configuration-and-GameRules]] |
| **아키텍처 및 애드온 확장 훅** | 패키지 아키텍처, 제로 Mixin 설계, CustomStackSizeOverride | [[26.2 아키텍처 및 애드온 확장 훅|ko_kr-26.2-Architecture-and-Addon-Hooks]] |
| **개발자 설정 및 툴체인** | JDK 25 환경, Gradle 9.3+ 빌드 명령, Loom 설정 | [[26.2 개발자 설정 및 툴체인|ko_kr-26.2-Developer-Setup-and-Building]] |
