...
| :--- | :--- |
| **Mod Identifier** | `potion-stacker-addon` |
...
Potion Stacker Addon strictly adheres to the **1 Jar 1 Version Policy**: every major Minecraft version anchor receives a discrete, dedicated binary compiled specifically against that target's obfuscation mapping, bytecode structure, and Fabric API lifecycle.
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **MC 26.2** (`26.1.2` / `26.2`) | `1.1.3+26.2` | `>=0.19.1` | JDK 25 (`>=25`) | `0.150.1+26.2` | `>=1.8.3` | `>=1.4.10+26.2` | 🟢 Standard Anchor |
| **MC 26.3** (`26.3-snapshot-6` / `26.3`) | `1.1.3+26.3` | `>=0.19.3` | JDK 25 (`>=25`) | `0.156.1+26.3` | `>=1.8.36` | `>=1.4.18` | 🟢 Modern Lead |
...
* `potion-stacker-addon-1.1.3+26.2.jar`: Target anchor for stable MC 26.1.2 and MC 26.2 installations.
* `potion-stacker-addon-1.1.3+26.3.jar`: Target anchor for developmental snapshot environments (MC 26.3-snapshot-6 and beyond).

### Universal DasikLibrary Integration
Potion Stacker Addon relies on **DasikLibrary** for dynamic runtime GameRule registration (`DynamicGameRuleManager`), category allocation, and configuration management (`ConfigHelper`). DasikLibrary follows an open version bound architecture (`>=26.1.2-`), guaranteeing:
...
5. Launch the game and inspect the log for:
   `[potion-stacker-addon] Instant Gratification: Potion Stacker Initialized`

---

## 5. Related Documentation Links
* Return to the [[Main Wiki Portal|Home]].
* Read the [[26.2 Potion Stacking & Inventory Ergonomics|26.2-Potion-Stacking-and-Inventory-Ergonomics]].
* Read the [[26.3 Potion Stacking & Inventory Ergonomics|26.3-Potion-Stacking-and-Inventory-Ergonomics]].
